...
app.post("/", function(req, res) {
    ...
    if(listNmae === "Today") {
        ...
        list.findOne({name: listNmae}, function(err, foundList){
            foundList.items.push(newItem);
            fonndList.save(function(){
...
app.post("/delete", function(req, res){
    ...
    const listNmae= req.body.listNmae;
    ...
    if(listNmae === "Today") {
        ...
        List.findOneAndUpdate({name: listNmae}, {$pull: {items: {_id: checkedItemId}}}, function(err, foundList){
            if (!err) {
                res.redirect("/" + listNmae);
            }
        });
